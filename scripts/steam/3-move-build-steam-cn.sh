...
if [ -f src-core/target/release/SleepFit.exe ]; then
cp src-core/target/release/SleepFit.exe SteamSDK/sdk/tools/ContentBuilder/content/Win64_CN/
...
elif [ -f src-core/target/debug/SleepFit.exe ]; then
cp src-core/target/debug/SleepFit.exe SteamSDK/sdk/tools/ContentBuilder/content/Win64_CN/

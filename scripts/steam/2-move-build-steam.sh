...
cp src-core/target/release/SleepFit.exe SteamSDK/sdk/tools/ContentBuilder/content/Win64/
...
cp src-core/target/debug/SleepFit.exe SteamSDK/sdk/tools/ContentBuilder/content/Win64/

...
export interface OyasumiSidecarState {
  ...
  /**
   * @generated from protobuf field: OyasumiOverlaySidecar.OyasumiSidecarVolumeState volume_state = 13
   */
  volumeState?: OyasumiSidecarVolumeState;
}
/**
...
/**
 * @generated from protobuf message OyasumiOverlaySidecar.OyasumiSidecarVolumeState
 */
export interface OyasumiSidecarVolumeState {
  /**
   * @generated from protobuf field: bool enabled = 1
   */
  enabled: boolean;
  ...
  value: number;
  /**
   * @generated from protobuf field: bool transitioning = 3
   */
  transitioning: boolean;
  /**
   * @generated from protobuf field: double transition_target = 4
   */
  transitionTarget: number;
}
/**
...
class OyasumiSidecarState$Type extends MessageType<OyasumiSidecarState> {
  constructor() {
    super('OyasumiOverlaySidecar.OyasumiSidecarState', [
      ...
      { no: 13, name: 'volume_state', kind: 'message', T: () => OyasumiSidecarVolumeState },
    ]);
  }
  create(value?: PartialMessage<OyasumiSidecarState>): OyasumiSidecarState {
    ...
    message.vrcUsername = '';
    message.locale = '';
    message.sleepPreparationAvailable = false;
    message.sleepPreparationTimedOut = false;
    message.systemMicMuted = false;
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* OyasumiOverlaySidecar.OyasumiSidecarCCTState cct_state */ 12:
          ...
          break;
        case /* OyasumiOverlaySidecar.OyasumiSidecarVolumeState volume_state */ 13:
          message.volumeState = OyasumiSidecarVolumeState.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.volumeState
  ...
  internalBinaryWrite(
    ...
    /* OyasumiOverlaySidecar.OyasumiSidecarVolumeState volume_state = 13; */
    if (message.volumeState)
      OyasumiSidecarVolumeState.internalBinaryWrite(
        message.volumeState,
...
class OyasumiSidecarOverlaySettings$Type extends MessageType<OyasumiSidecarOverlaySettings> {
  ...
  create(value?: PartialMessage<OyasumiSidecarOverlaySettings>): OyasumiSidecarOverlaySettings {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.systemMicIndicatorEnabled = false;
    message.systemMicIndicatorOpacity = 0;
    message.systemMicIndicatorFadeout = false;
    message.systemMicIndicatorVoiceActivationMode = 0;
    if (value !== undefined)
...
class OyasumiSidecarDeviceInfo_Controller$Type extends MessageType<OyasumiSidecarDeviceInfo_Controller> {
  ...
  create(
    ...
    message.dongleId = '';
    message.battery = 0;
    message.isTurningOff = false;
    message.canPowerOff = false;
    message.isCharging = false;
    message.providesBatteryStatus = false;
    if (value !== undefined)
...
class OyasumiSidecarAutomationsState_ShutdownAutomations$Type extends MessageType<OyasumiSidecarAutomationsState_ShutdownAutomations> {
  ...
  create(
    ...
    const message = globalThis.Object.create(this.messagePrototype!);
    message.triggersEnabled = false;
    message.running = false;
    message.canStart = false;
    message.triggersConfigured = 0;
    if (value !== undefined)
...
class OyasumiSidecarAutomationsState_SleepModeEnableForSleepDetector$Type extends MessageType<OyasumiSidecarAutomationsState_SleepModeEnableForSleepDetector> {
  ...
  create(
    ...
    message.enabled = false;
    message.sensitivity = '';
    message.activationWindow = false;
    message.activationWindowStart = [];
    message.activationWindowEnd = [];
    if (value !== undefined)
...
class OyasumiSidecarBrightnessState$Type extends MessageType<OyasumiSidecarBrightnessState> {
  ...
  create(value?: PartialMessage<OyasumiSidecarBrightnessState>): OyasumiSidecarBrightnessState {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.advancedMode = false;
    message.brightness = 0;
    message.hardwareBrightness = 0;
    message.softwareBrightness = 0;
    message.brightnessTransitioning = false;
    message.hardwareBrightnessTransitioning = false;
    message.softwareBrightnessTransitioning = false;
    message.brightnessTransitionTarget = 0;
    message.hardwareBrightnessTransitionTarget = 0;
    message.softwareBrightnessTransitionTarget = 0;
    message.hardwareBrightnessAvailable = false;
    message.hardwareMinBrightness = 0;
    message.hardwareMaxBrightness = 0;
    if (value !== undefined)
...
// @generated message type with reflection information, may provide speed optimized methods
class OyasumiSidecarVolumeState$Type extends MessageType<OyasumiSidecarVolumeState> {
  constructor() {
    super('OyasumiOverlaySidecar.OyasumiSidecarVolumeState', [
      { no: 1, name: 'enabled', kind: 'scalar', T: 8 /*ScalarType.BOOL*/ },
      { no: 2, name: 'value', kind: 'scalar', T: 1 /*ScalarType.DOUBLE*/ },
      { no: 3, name: 'transitioning', kind: 'scalar', T: 8 /*ScalarType.BOOL*/ },
      { no: 4, name: 'transition_target', kind: 'scalar', T: 1 /*ScalarType.DOUBLE*/ },
    ]);
  }
  create(value?: PartialMessage<OyasumiSidecarVolumeState>): OyasumiSidecarVolumeState {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.enabled = false;
    message.value = 0;
    message.transitioning = false;
    message.transitionTarget = 0;
    if (value !== undefined)
      reflectionMergePartial<OyasumiSidecarVolumeState>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    length: number,
    options: BinaryReadOptions,
    target?: OyasumiSidecarVolumeState
  ): OyasumiSidecarVolumeState {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        ...
        case /* double value */ 2:
          ...
          break;
        case /* bool transitioning */ 3:
          message.transitioning = reader.bool();
          break;
        case /* double transition_target */ 4:
          message.transitionTarget = reader.double();
          break;
        default:
          let u = options.readUnknownField;
          if (u === 'throw')
  ...
  internalBinaryWrite(
    message: OyasumiSidecarVolumeState,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
    /* bool enabled = 1; */
    ...
    /* bool transitioning = 3; */
    if (message.transitioning !== false) writer.tag(3, WireType.Varint).bool(message.transitioning);
    /* double transition_target = 4; */
    if (message.transitionTarget !== 0)
      writer.tag(4, WireType.Bit64).double(message.transitionTarget);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
/**
 * @generated MessageType for protobuf message OyasumiOverlaySidecar.OyasumiSidecarVolumeState
 */
export const OyasumiSidecarVolumeState = new OyasumiSidecarVolumeState$Type();
/**

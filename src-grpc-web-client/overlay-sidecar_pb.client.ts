...
export interface IOyasumiOverlaySidecarClient {
  /**
   * @generated from protobuf rpc: AddNotification
   */
  addNotification(
  ...
  /**
   * @generated from protobuf rpc: ClearNotification
   */
  clearNotification(
  ...
  /**
   * @generated from protobuf rpc: SyncState
   */
  syncState(
  ...
  /**
   * @generated from protobuf rpc: SetDebugTranslations
   */
  ...
  /**
   * @generated from protobuf rpc: OpenOverlayMenu
   */
  openOverlayMenu(
  ...
  /**
   * @generated from protobuf rpc: CloseOverlayMenu
   */
  closeOverlayMenu(input: Empty, options?: RpcOptions): UnaryCall<Empty, Empty>;
  /**
   * @generated from protobuf rpc: ToggleOverlayMenu
   */
  toggleOverlayMenu(
    input: OverlayMenuOpenRequest,
    options?: RpcOptions
  ...
  /**
   * @generated from protobuf rpc: SetMicrophoneActive
   */
  setMicrophoneActive(
